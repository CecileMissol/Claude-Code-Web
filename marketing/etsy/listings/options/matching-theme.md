# Etsy listing — Option: matching full wedding website
...
(`docs/strategie-produit.md` §1.1-1.2, §4).

## Title (≤ 140 characters)

> **Matching Full Wedding Website Add-On | Extra Pages Details FAQ Accommodations | {{BRAND_NAME}} Companion Site Upgrade**

118 characters.

## Tags (≤ 20 characters each)

`wedding website addon`, `full wedding site`, `wedding details page`,
`wedding faq page`, `wedding website`, `digital add-on`,
`accommodations page`
...
**$19 USD**, compare-at **$29 USD** (`docs/strategie-produit.md` §4).
...
scripts — for the practical details guests look for closer to the big day.

**What you receive**

This digital download contains a short guide explaining how to unlock the
...
- Simple navigation menu added to your existing invitation, same link
- Fully matched to your theme's palette, script and illustrations —
