...
import {
  ...
  programLayout,
  spread,
} from '@/themes/mariage-noir-ivoire/animations/thresholds';

/**
 * The scroll maths of the theme. These numbers are what makes the rendering
 * faithful to `reference/invitation-mariage-demo.html`, so they are pinned.
 */
...
describe('lineThresholds', () => {
  it('reproduces the mock-up for the five sentences of the story', () => {
    // Mock-up: .04 .22 .4 .58 .78 — evenly spread over the same band.
...
describe('programLayout', () => {
  it('reproduces the four cards of the mock-up', () => {
...
describe('mock-up constants', () => {
  it('keeps the chapter lengths of the mock-up', () => {
    expect(CHAPTER_LENGTH).toEqual({ story: 420, date: 320, program: 380, place: 300 });
  });

  it('keeps the intro beats of the mock-up, in seconds', () => {
