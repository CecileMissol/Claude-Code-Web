...
| `gypsophile.svg` | `0 0 120 120`  | oui          | `--stem`                       | *Optionnel.* Nuage de très petites fleurs, pour densifier les bouquets de l'enveloppe.            |
| `olive-branch.svg` | `0 0 160 60` | oui          | `--stem`                       | *Optionnel.* Rameau d'olivier, utile surtout pour la palette `olivier`.                           |
...
| `grain.png`                   | 220 × 220 px, tuile| oui          | non         | *Optionnel.* Remplacerait le `feTurbulence` en data-URI si on veut un grain plus photographique.|
